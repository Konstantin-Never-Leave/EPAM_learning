import Task_1_1_release
import Task_1_2_release
import Task_1_3_release
import Task_1_3_1_release
import Task_1_4_release
import Task_1_5_release
import Task_1_6_release
import Task_1_6_1_release
...
checking_value_1_3_1 = 60
expected_output_1_3_1 = [1, 2, 3, 4, 5, 6, 10, 12, 15, 20, 30, 60]
...
if __name__ == "__main__":
    def check_1st_task(check_value, expect_output):
        ...
        if (Task_1_1_release.main(check_value)) == expect_output:
    ...
    def check_2nd_task(check_value, expect_output):
        ...
        if (Task_1_2_release.main(check_value)) == expect_output:
            return "\033[42m {}\033[0m".format(msg_passed)
    ...
    def check_3d_task(check_value, expect_output):
        ...
        :return: passed or not passed msg
        """
        if (Task_1_3_release.main(check_value)) == expect_output:
            return "\033[42m {}\033[0m".format(msg_passed)
    ...
    def check_3_1th_task(check_value, expect_output):
        ...
        if (Task_1_3_1_release.main(check_value)) == expect_output:
            return "\033[42m {}\033[0m".format(msg_passed)
    ...
    def check_4th_task(check_value, expect_output):
        ...
        if (Task_1_4_release.main(check_value)) == expect_output:
            return "\033[42m {}\033[0m".format(msg_passed)
    ...
    def check_5th_task(check_value, expect_output):
        ...
        if (Task_1_5_release.main(check_value)) == expect_output:
            return "\033[42m {}\033[0m".format(msg_passed)
    ...
    def check_6th_task(check_value, expect_output):
        ...
        if (Task_1_6_release.main(check_value)) == expect_output:
            return "\033[42m {}\033[0m".format(msg_passed)
    ...
    def check_6_1th_task(a, b, c, d):
        ...
        return Task_1_6_1_release.main(a, b, c, d)
